...
# :white_check_mark: FIXED: Proper log reconstruction
combined_logs = []
temp = []
...
# :white_check_mark: SAFETY CHECK (prevents your crash)
if not entries:
    print(":x: No valid log entries found. Check your log format.")
    exit()
